...
def get_args():
    ...
    parser.add_argument("--model_path", type=str, default="data/tpe_models/DeepSeek-R1-Distill-Qwen-1.5B_task-icu_phenotyping_maxN-3_maxM-5000", help="LLM model path.")
